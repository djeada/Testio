...
class TestSanitizeOutput:
    ...
    def test_long_output_truncated(self):
        """Test that long output is truncated within the maximum length."""
...
class TestValidateCommand:
    ...
    def test_unsupported_command_raises_error(self):
        """Test that unsupported executables are rejected."""
        with pytest.raises(ValidationError) as exc_info:
            validate_command("totally-unknown-runner")
        assert "unsupported executable" in exc_info.value.message.lower()
